...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: true,
		src: "https://i.postimg.cc/T132TDMc/1.jpg", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/xuluhui-code/fuwari", // Internal links should not include the base path, as it is automatically added
